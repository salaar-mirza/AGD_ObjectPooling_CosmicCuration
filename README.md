...
<div align="center">
  <img src="Gameplay/Gameplay.png" alt="Gameplay" width="45%"/>
  <img src="Gameplay/GameOver.png" alt="Game Over" width="45%"/>
</div>
...
To avoid performance spikes from frequent `Instantiate()` and `Destroy()` calls, the project uses a robust object pooling system for bullets, enemies, and VFX. When an object is "destroyed," it is simply deactivated and returned to its pool, ready to be reused. The logic finds an unused object in the pool, or creates a new one if the pool is exhausted.
```csharp
...
<div align="center">
  <img src="UmlDiagram/ClassesDiagram.png" alt="Class Diagram" width="800"/>
</div>
